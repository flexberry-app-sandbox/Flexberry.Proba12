...
Router.map(function () {
  ...
  this.route('i-i-s-proba1-формир-распред-e',
  { path: 'i-i-s-proba1-формир-распред-e/:id' });
  this.route('i-i-s-proba1-формир-распред-e.new',
  { path: 'i-i-s-proba1-формир-распред-e/new' });
