...
moduleForModel('i-i-s-proba1-формир-распред', 'Unit | Serializer | i-i-s-proba1-формир-распред', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-proba1-формир-распред',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
    ...
    'model:i-i-s-proba1-формир-распред',
