...
namespace IIS.Proba1
{
    ...
    [View("ФормирРаспредE", new string[] {
            ...
            "ДокумПостав.Клиенты",
            "ДокумПостав.Клиенты.НаимЗаказ as \'наим заказ\'"}, Hidden=new string[] {
            "СписокКонтей",
    ...
    public class ФормирРаспред : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ФормирРаспредE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФормирРаспредE", typeof(IIS.Proba1.ФормирРаспред));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ФормирРаспредL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФормирРаспредL", typeof(IIS.Proba1.ФормирРаспред));
                }
            }
        }
    }
