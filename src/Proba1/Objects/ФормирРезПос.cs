...
namespace IIS.Proba1
{
    ...
    public class ФормирРезПос : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba1.ФормирРаспред fФормирРаспред;
        ...
        [PropertyStorage(new string[] {
                "ФормирРаспред"})]
        [NotNull()]
        public virtual IIS.Proba1.ФормирРаспред ФормирРаспред
        {
            get
            {
                ...
                IIS.Proba1.ФормирРаспред result = this.fФормирРаспред;
